...
class PhotosTimelinePresenterTests: XCTestCase {
  ...
  // MARK: Tests
    ...
    func testPresentFetchedMediaShouldFormatMediaForDisplay() {
        ...
        let media = [Media(imageId: 1, name: "Foto 1", desc: "Bonita", createdAt: date, category: 0, width: 0, height: 0, imageUrl: "http://www.dumpaday.com/wp-content/uploads/2011/04/Random-Funny-Photos-Part-132_14-2.jpg")]
